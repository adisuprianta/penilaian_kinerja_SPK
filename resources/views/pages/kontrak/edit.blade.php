...
@section('title','Edit Kontrak Karyawan')
@section('header-title','Edit Kontrak Karyawan')
...
<div class="card shadow mb-4 col-lg-6">
    <div class="card-body">
        ...
        <form action="{{route('kontrak.update',$kontrak->id_kontrak)}}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="input-group date" id="datepicker">
                        <input type="text"  name="tgl_kerja" id="tgl_kerja" class="form-control @error('tgl_kerja') is-invalid @enderror" value="{{$kontrak->tanggal_kerja}}">
            ...
            <fieldset class="form-group">
                ...
                <legend class="col-form-label col-sm-4 pt-0">Status</legend>
                    <div class="col-sm-7">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="status" value="T" checked>
                            <label class="form-check-label" for="gridRadios2">
                                Tidak Aktif
                            </label>
                        </div>
            ...
            <div class="form-group">
                ...
                <input type="file" name="berkas" rows="3" id="berkas" class="form-control-file @error('berkas') is-invalid @enderror" value="{{url('/berkas_kontrak/'.$kontrak->berkas_kontrak)}}">
                @error('berkas')
                <div class="text-danger">
                    {{ $message }}
                </div>
