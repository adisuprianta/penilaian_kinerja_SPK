...
class LaporanController extends Controller
{
    public function index(){
        ...
        // dd($max);
        return view('pages.laporan.index',['min'=>$min,'max'=>$max,'karyawan'=>$karyawan,'nilai_sub_kriteria'=>$nilai_sub_kriteria,'nilai_kriteria'=>$nilai_kriteria,'kriteria'=>$kriteria,'subkriteria'=>$subkriteria]);
    ...
    public function cetak_pdf(Request $request ){
        ...
        ->get();
        // dd(1);
        $pdf= PDF::loadview('pages.laporan.index_pdf',['min'=>$min,'max'=>$max,'karyawan'=>$karyawan,'nilai_sub_kriteria'=>$nilai_sub_kriteria,'nilai_kriteria'=>$nilai_kriteria,'kriteria'=>$kriteria,'subkriteria'=>$subkriteria])->setPaper('a4', 'landscape');
